...
{ 
			...
			if($_FILES['ja_add_image1']['name'] <> "") {
				   ...
				   $qry_upd = "UPDATE hht_poojas SET pooja_title = '".addslashes(trim($_POST['title']))."',
											 pooja_status = '1',
												pooja_type = '".addslashes(trim($_POST['dtype']))."',	
		...
		if(mysqli_query($conn,$qry_upd))
		{
			...
			$_SESSION['msg'] = "Donation details updated successfully";
...
if($_GET['j_id'] > 0)
{
	$h1tag = "Edit Donation Details"; 
}
else
{
	$h1tag = "Add Donation Details"; 
}
?>
    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
          <form action="edit_donation.php" enctype="multipart/form-data" name="addpurchasefrm" method="post" id="addpurchasefrm" >
          <input type="hidden" name="j_id" value="<?php echo $_GET['j_id']; ?>" />
            <table width="140%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td class="bold aright">Donation Title : <span class="red14">* </span></td>
                <td>
                	
                    <input type="text" name="title" id="title" placeholder="" value="<?php echo $res_details['pooja_title'];?>" required /></td>
              </tr>
                           <tr>
                <td class="bold aright">Donation Status : <span class="red14">* </span></td>
                <td>
                ...
                <tr>
                <td class="bold aright">Donation Type : <span class="red14">* </span></td>
                <td>
                                    <input type="text" name="dtype" id="dtype" placeholder="" value="<?php echo $res_details['pooja_type'];?>" required /></td>
	
                 </td>
              </tr>
             
               <tr>
                <td class="bold aright">Donation Amount in £ : <span class="red14">* </span></td>
                <td>
               ...
               <tr>
                <td class="bold aright">Donation Description : <span class="red14">* </span></td>
                <td>
                ...
                <tr>
                <td class="bold aright">Donation Image 1 : </td>
