...
if($_REQUEST['save'] == "CONTINUE"  && $_POST['fname']!='')
{
	 ...
	 $qry_add = "INSERT INTO hht_users SET 	 e_status = '1',
			...
			$_SESSION['usrweb_ida'] = addslashes(trim($_POST['email']));
			$_SESSION['usrweb_fnamea'] = addslashes(trim($_POST['fname']));
    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
        ...
        <h2 style="font-size:14px;">Register & Create an account</h2><br />
		 <div class="login_main">
          	<div class="p-0 bg-transparent " id="headingTwo">
               
                <p class="marleft bold">Your Personal Details</p><br />
          <form action="signup.php" enctype="multipart/form-data" name="register" method="post" id="register" >
