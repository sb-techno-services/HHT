          ...
          <div class='row'>
            <div class='col-md-12'>
              ...
              <table class='table table-striped table-bordered'>
                ...
                <tfoot>
                  <tr>
                    <td colspan='3'><a href='manual_order.php' class="btn btn-success vibtnnew" style="background-color:#28a745;"> &laquo; Continue Shopping</a></td>
                    <th>Total</th>
                    ...
                    <td style="width:155px;"><a href='manual_receipt.php' class='btn btn-info vibtnnew' style="background-color:#CA0000; border:none; ">Checkout &nbsp; &raquo; </a></td>
                  </tr>
                </tfoot>
              </table>
              <?php else: ?>
