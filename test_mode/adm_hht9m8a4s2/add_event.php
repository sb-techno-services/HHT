...
if($_REQUEST['save'] == "Submit"  && $_POST['title']!='')
{
	...
	$date4 = $date3[2].'-'.$date3[1].'-'.$date3[0];
	 ...
	 $qry_add = "INSERT INTO hht_events SET event_title = '".addslashes(trim($_POST['title']))."',
											 event_status = '1',
											 ...
											 event_ip = '".$_SERVER['SERVER_ADDR']."',
											   event_adddate = '".date('Y-m-d')."'"; 
		if(mysqli_query($conn,$qry_add))
		{
		   

			$_SESSION['msg'] = "Events details Added successfully";
    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
          <form action="add_event.php" enctype="multipart/form-data" name="addpurchasefrm" method="post" id="addpurchasefrm" >
