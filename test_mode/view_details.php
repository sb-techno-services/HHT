        ...
        <div class='container mt-5'>
			<div class='row'>
             ...
             <p> <img src="images/thumb_donation.jpg"></p>
              <?php } else { ?>
             <p> <img src="../test_mode/adm_hht9m8a4s2/uploads/<?=$data['pooja_image']?>" style='height:130px;'></p>
              <?php } ?>
						</div>	
						<div class='col-md-8'>
							<h2 class='text-muted'><?php echo $data["pooja_title"]; ?></h2>
							<p style="width:75px; float:left;">Donation :</p> <p style="font-weight:bold; color:#FF0000; font-size:18px;">£<?php echo $data["price"]; ?></p>
