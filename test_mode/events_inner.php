...
//echo "SELECT *,DATE_FORMAT(event_sdate, '%a, %M %e, %Y') as sdate,DATE_FORMAT(event_edate, '%a, %M %e, %Y') as edate FROM hht_events where ja_id = ".$_GET['j_id'];
...
<?php */?>         </div>
      ...
      <div class="events_inner_main">
            ...
            <div class="gurumid_1">
						...
						//   echo "<br>".$res_details['event_image'];
						   
						   ?>

            	<img src="../test_mode/adm_hht9m8a4s2/uploads/<?=$res_details['event_image']?>"> 
                       <?php } ?>
           </div>
            <div class="gurumid_1">
             <?php if($res_details['event_image2'] !="") { ?>
            	<img src="../test_mode/adm_hht9m8a4s2/uploads/<?=$res_details['event_image2']?>">
                 <?php } ?>            </div>
      </div>
      </div>
