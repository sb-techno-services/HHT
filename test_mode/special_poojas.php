...
================================================== -->
  <meta charset="utf-8">
  <title>Pooja Services - Special Poojas</title>
...
<nav aria-label="breadcrumb" style="border:none;">
    <ol class="breadcrumb justify-content-center">
      ...
      <li class="breadcrumb-item">Pooja Services - Special Poojas</li>
    </ol>
</nav>

		<div class="pooja-services_main">
           <?php
                $sql_purchase = mysqli_query($conn,"SELECT *,DATE_FORMAT(pooja_sdate, '%a, %M %e, %Y') as sdate,DATE_FORMAT(pooja_edate, '%a, %M %e, %Y') as edate FROM hht_poojas where pooja_category='Special Poojas' AND pooja_status=1 order by ja_id DESC");	
