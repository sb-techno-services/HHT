...
<div class="mytitle_header">
	<div class="container"><h2>Donation Details</h2></div>
</div>
<div class="container">
    <div class="row">
      ...
      <div style="margin-bottom:0; border-radius: 5px 5px 0 0;" class="events_inner_main">
      		<div class="gurumid_details">
            	<div class="left"><img src="events_gallery/images/categories_img1.jpg" width="300" height="300"></div>
           		<div class="right"><h4 style="color:#000; border-bottom:1px solid #dedede; padding:0 0 20px 0;"><?php echo $res_details['pooja_title'];?></h4>
           
            <div style="width:35%;" class="left">Donation Amount : <br><br>
            	
            </div>
            <div class="right">
            	<select id="" name="">
                    <option value="<?php echo $res_details['price'];?>">   £<?php echo $res_details['price'];?></option>
                </select><br>
    ...
    <p><?php echo $res_details['pooja_des'];?>
      ...
      <div class="col-12 col-lg-4 col-md-12 col-sm-12 col-xs-6 filter health">
       ...
       <div class="events_inner_main">
       	<h4 style="margin:15px 0;">OTHER DONATIONS</h4>
         <?php
                $sql_purchase = mysqli_query($conn,"SELECT * FROM hht_poojas WHERE category = 'donations' AND pooja_status=1 AND ja_id <> ".$_GET['j_id']." order by ja_id DESC");	
       	...
       	<div class="events_cal">
            ...
            <div class="right"> <p style="color:#999;"><a href="donation_details_<?=$arrUsersRow['ja_id']?>.html"><?php echo $arrUsersRow['pooja_title'];?></a></p> <p> £<?php echo $arrUsersRow['price'];?></p></div>
         </div>
         <?php
            }
          	?>
