...
$qry_account = mysqli_query($conn,"SELECT * FROM hht_poojas WHERE category = 'donations'");
...
<title>:: <?php echo $DOMAIN_NAME_PAGE.' Donation Details';?> ::</title>
  ...
  <div id="wrapper">
    ...
    <section>
      ...
      <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
        <div class="btn"><a href="add_donation.php">ADD Donations </a></div>
          <table width="130%" border="0"  cellpadding="0" cellspacing="0">
            <tbody>
           
              <tr>
                <th width="8%" align="center" valign="middle" bgcolor="#d8d1e9">S.No.</th>
                <th width="12%" align="center" valign="middle" bgcolor="#d8d1e9">Donation Title</th>
                <th width="21%" align="center" valign="middle" bgcolor="#d8d1e9">Donation Price</span></th>
                <th width="21%" align="center" valign="middle" bgcolor="#d8d1e9">Action</th>
                
              </tr>
              <?php
                $sql_purchase = mysqli_query($conn,"SELECT * FROM hht_poojas WHERE category = 'donations' order by ja_id DESC");	
			...
			?>
              <tr class="<?=$class?>">
                ...
                <td align="left">£<?=$arrUsersRow['price']?></td>
                <td align="left"><a href="donation_view.php?j_id=<?=$arrUsersRow['ja_id']?>">View</a> | <a href="edit_donation.php?j_id=<?=$arrUsersRow['ja_id']?>">Edit</a> | <a href="donations.php?j_id=<?=$arrUsersRow['ja_id']?>">Delete</a></td>
              </tr>
              <?php				  	
