    ...
    $.fn.style_my_tooltips = function (options) {
        ...
        return this.each(function () {
            ...
            $(this).hover(function (e) {
                ...
                //Do not show the custom tooltip if the title attribute is empty
                ...
                $this.attr("copyTitle", toolTipText);
                $this.data("smtTitle", toolTipText); //store title 
                ...
                //Check for empty title attributes
                var toolTipText = $this.attr("copyTitle");
