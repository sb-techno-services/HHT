    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
          <form action="add_pooja.php" enctype="multipart/form-data" name="addpurchasefrm" method="post" id="addpurchasefrm" >
              ...
              <tr>
               ...
               <tr>
                ...
                <td>
                  ...
                  <option value="Regular Poojas" selected="selected">Regular Poojas</option>
