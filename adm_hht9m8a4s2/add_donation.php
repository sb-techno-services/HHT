...
if($_REQUEST['save'] == "Submit"  && $_POST['title']!='')
{
	 ...
	 $qry_add = "INSERT INTO hht_poojas SET pooja_title = '".addslashes(trim($_POST['title']))."',
											 pooja_status = '1',
		...
		if(mysqli_query($conn,$qry_add))
		{
			...
			$_SESSION['msg'] = "Donation details Added successfully";
    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
          <form action="add_donation.php" enctype="multipart/form-data" name="addpurchasefrm" method="post" id="addpurchasefrm" >
          <input type="hidden" name="j_id" value="<?php echo $_GET['j_id']; ?>" />
            <table width="140%" border="0" cellspacing="0" cellpadding="5">
              <tr>
               ...
               <tr>
                <td class="bold aright">Donation Price in £ : <span class="red14">* </span></td>
                <td>
               ...
               <tr>
                ...
                <tr>
                <td class="bold aright">Upload Donation Image  : </td>
