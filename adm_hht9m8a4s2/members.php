...
$qry_account = mysqli_query($conn,"SELECT * FROM hht_users ");
$account = mysqli_fetch_assoc($qry_account);

if($_GET['e_id']){
	$qry=mysqli_query($conn,"select e_id from hht_users WHERE e_id=".$_REQUEST['e_id']."");

	$res=mysqli_fetch_assoc($qry);
	if(mysqli_num_rows($qry)>0){
		$del=mysqli_query($conn,"delete from hht_users WHERE e_id=".$_REQUEST['e_id']."");
...
<title>:: <?php echo $DOMAIN_NAME_PAGE.' Members Details';?> ::</title>
          ...
          <table width="130%" border="0"  cellpadding="0" cellspacing="0">
            <tbody>
              ...
              <tr>
                ...
                <th width="12%" align="center" valign="middle" bgcolor="#d8d1e9">Member Name</th>
              ...
              <?php
                $sql_purchase = mysqli_query($conn,"SELECT * FROM hht_users order by e_id DESC");	
			...
			?>
              <tr class="<?=$class?>">
                ...
                <td align="left"><?=$arrUsersRow['e_fname']?> &nbsp;<?=$arrUsersRow['e_lname']?></td>
                <td align="left"><?=$arrUsersRow['email']?></td>
                <td align="left"><a href="user_view.php?e_id=<?=$arrUsersRow['e_id']?>">View</a> |  <a href="members.php?e_id=<?=$arrUsersRow['e_id']?>">Delete</a></td>
              </tr>
              <?php				  	
