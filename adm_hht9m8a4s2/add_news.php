...
if($_REQUEST['save'] == "Submit"  && $_POST['title']!='')
{
	 ...
	 $qry_add = "INSERT INTO hht_news SET news_title = '".addslashes(trim($_POST['title']))."',
											 news_status = '1',
		...
		if(mysqli_query($conn,$qry_add))
		{
			...
			$_SESSION['msg'] = "News details Inserted successfully";
    ...
    <section>
      ...
      <article>
       <?php //include_once("employee_detials_left.php"); ?>
		...
		?>
          <form action="add_news.php" enctype="multipart/form-data" name="addpurchasefrm" method="post" id="addpurchasefrm" >
